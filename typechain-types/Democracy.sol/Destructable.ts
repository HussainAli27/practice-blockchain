...
export interface DestructableInterface extends Interface {
  getFunction(nameOrSignature: "destroy" | "isDestroyed"): FunctionFragment;
...
export interface Destructable extends BaseContract {
  connect(runner?: ContractRunner | null): Destructable;
